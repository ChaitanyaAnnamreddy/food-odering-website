...
export default function Footer() {
  return (
    <div>
      <footer class="bg-gray-500 text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left mb-8">
        ...
        <div class="mx-6 py-10 text-center md:text-left ml-[600px] ">
